  ...
  <select className="select select-bordered ">
    ...
    <option>Kids</option>
            ...
            <div className="relative flex">
              <input type="text" placeholder="Search here"className="border-b border-2 p-1 rounded "/>
        ...
        <div className="flex items-center gap-[45px] size-7 relative">
            ...
            <div className="size-[15px] bottom-4 left-4 flex justify-center items-center bg-red-500 rounded-3xl text-white absolute ">0</div>
        </div>
